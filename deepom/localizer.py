...
class Keys:
    ...
    OFFSETS = None
    SCALES = None
    ALIGN_MAP_THRESHOLD = None
    GENOME_DESC = None
    ALIGN_CANDIDATE_SITES = None
    BIONANO_GENOME_COORDS = None
    BIONANO_SEGMENT_DEF = None
    ALIGN_EXTRA = None
    ALIGN_MATCHED_SITES = None
    ALIGN_BIN_SCORE = None
    ALIGN_MODEL = None
    ALIGN_COORDS = None
    ALIGN_COORDS_TARGET = None
    ALIGN_SITES_TARGET = None
    ALIGN_GENOME_ITEM = None
    ALIGN_IMAGE_ITEM = None
    ALIGN_LABEL = None
    ALIGN_MAP = None
    ALIGN_MASK = None
    ALIGN_PRODUCT = None
    ALIGN_REGION = None
    ALIGN_REGION_COORDS = None
    ALIGN_REGION_MAP = None
    ALIGN_REGION_MASK = None
    ALIGN_SCORE = None
    ALIGN_SLICE = None
    ALIGNED_LOCS = None
    ALIGNER: str = None
    ...
    ANGLE = None
    AVG_SCALE = None
    AXIS_MAJOR_LENGTH = None
    BATCH_ITEMS = None
    BBOX = None
    BLEND: str = None
    BLINK_ON_P = None
    BLINK_ON_P_RANGE = None
    CENTROID = None
    COORDS = None
    DATA_ITEM = None
    ...
    EMITTER_COORDS = None
    EMITTER_FIELD = None
    EMITTER_INTENSITY = None
    EMITTER_MAP: str = None
    ESIMATED_OFFSET = None
    ESIMATED_SCALE = None
    FALSE_GENOME = None
    FRAGMENT_LEN = None
    FRAGMENT_LIMS = None
    FRAGMENT_OFFSET = None
    FRAGMENT_SITEVEC = None
    FRAME_LOCVECS = None
    FRAME_SLICE = None
    GENOME_INDEX = None
    GENOME_INPUT = None
    ...
    GENOME_MASK = None
    GENOME_PROFILE = None
    GT_ALIGN_COORDS = None
    IMAGE_2D: str = None
    IMAGE_3D = None
    IMAGE_BLUR_SIGMA = None
    IMAGE_EMITTER_MAP = None
    IMAGE_FILE = None
    IMAGE_INPUT = None
    IMAGE_INTENSITY = None
    IMAGE_LABEL_2D: str = None
    IMAGE_PROFILE_1D = None
    IMAGE_PROFILE_2D = None
    IMAGE_PROFILE_2D_LABEL = None
    IMAGE_PROFILE_3D = None
    LABEL = None
    LABEL_EFF = None
    LABELED_COORDS = None
    LABELED_GENOME = None
    LABELED_SITEVEC = None
    LABELED_SITEVEC_INDICES = None
    LABELED_TARGET = None
    LAT_SIZE_MIN = None
    LOCALIZER: str = None
    LOCALIZER_OBJ = None
    ...
    REGION = None
    REVERSE = None
    SEG_LABEL_IMAGE = None
    SEG_MAP = None
    SEG_MAP_MASK = None
    SEG_REGION = None
    SEG_REGION_MASK = None
    SEGMENT_2D = None
    SEGMENT_3D = None
    SEGMENT_COORDS = None
    SEGMENT_INDEX = None
    ...
    SIMULATED_IMAGE_INDEX = None
    SIMULATED_SCALE = None
    SITEVEC = None
    SLICE = None
    SPARSITY = None
    STATS = None
    STRAY_EMITTER_COORDS = None
    STRAY_TARGET = None
    TIME_SIGMA = None
    TIME_SIZE = None
    TOTAL_LOCS = None
